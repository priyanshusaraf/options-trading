...
SPECS = node_contracts._freeze({'ANCHORED_VWAP': {'constraints': ['volume >= 0',
 ...
 'DISTANCE_FROM_SESSION_HIGH_LOW': {'constraints': ['canonical session prefix <= 100000 completed bar slots; '
                                    ...
                                    'inputs': ['high', 'low', 'close', 'session_id'],
 ...
 'PREVIOUS_SESSION_OHLC': {'constraints': ['canonical session prefix <= 100000 completed bar slots; '
                           ...
                           'inputs': ['open', 'high', 'low', 'close', 'session_id', 'session_close_at'],
                           'missing_policy': 'Missing declared field/role or unavailable binding refuses the '
                                             'call. NaN/infinity/missing bar yields an invalid output and '
                                             'restarts contiguous warmup; never substitute close, zero, prior '
                                             'price or peer=open.',
 ...
 'SESSION_OPEN_HIGH_LOW': {'constraints': ['canonical session prefix <= 100000 completed bar slots; '
                           ...
                           'inputs': ['open', 'high', 'low', 'session_id'],
                           'missing_policy': 'Missing declared field/role or unavailable binding refuses the '
                                             'call. NaN/infinity/missing bar yields an invalid output and '
                                             'restarts contiguous warmup; never substitute close, zero, prior '
                                             'price or peer=open.',
 ...
 'VWAP': {'constraints': ['volume >= 0',
          ...
          'formula': 'sum(((high+low+close)/3)*volume since canonical session open)/sum(volume since session '
                     'open).',
          'inputs': ['high', 'low', 'close', 'volume', 'session_id'],
          'missing_policy': 'Missing declared field/role or unavailable binding refuses the call. '
                            'NaN/infinity/missing bar yields an invalid output and restarts contiguous warmup; '
                            'never substitute close, zero, prior price or peer=open.',
          'outputs': {'value': {'dtype': 'float64_series', 'units': 'input_units'}},
