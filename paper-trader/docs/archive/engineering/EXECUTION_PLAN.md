...
[ADR 0001](../../engineering/decisions/0001-product-object-contract.md) rejects Project/watchlist execution roots,
...
[ADR 0002](../../engineering/decisions/0002-graph-version-research-binding.md) accepts copied immutable provenance
...
| C4 Reversible execution | Parity, replay, shadow, rollback and observability complete locally | L1 Stage 1 shadow lane engineering-closed with its admission contract; execution-state ownership defined, gated and wired into `EngineRunner` (ADR 0012); execution attribution canonicalised; **L1.3A managed non-authoritative shadow deployment binding built** (`ir_shadow_deployments`, migration `0011`). Remaining: ADR 0012 §3.2 paper authority — designed, unbuilt, owner-gated. Deployment and any authority promotion owner-gated |
