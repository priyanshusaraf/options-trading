...
For detailed current status, see [the verified gap map](../superpowers/specs/2026-08-12-strategy-os-v1-verified-gap-map.md), [the Phase 1 plan](../superpowers/plans/2026-08-11-phase-1-multi-user-contract.md), and [the roadmap](../../strategy-os-v1-v2-v3/V0-V1-V1.5-V2-V3-V4-V5-V6-SCOPE-DECISION-MATRIX.md).
