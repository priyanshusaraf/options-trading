---
{
  "id": "post-phase5-indicator-accuracy-core-return-stability-correction",
  "phase": "post-phase5",
  "status": "accepted",
  "kind": "critical_accuracy_correction",
  "goal": "Resolve F02 using numerically stable return/log-return and derived beta/alpha calculations, preserving strict thresholds, positive-variance validity, causal/restart behavior and bounded resource evidence.",
  "goal_contract": {
    "create_before_work": true,
    "stopping_condition": "Resolve F02 using numerically stable return/log-return and derived beta/alpha calculations, preserving strict thresholds, positive-variance validity, causal/restart behavior and bounded resource evidence. Complete only with focused RED/GREEN and mutation proof, exact source/identity preservation evidence, and a sealed local correction package. Independent numerical acceptance and publication remain separate."
  },
  "risk_tags": [
    "critical",
    "research-integrity",
  ...
  "dependency_gate": "post-phase5-indicator-accuracy-core-parameter-correction",
  "allowed_paths": [
    ...
    ".agent/runs/post-phase5-indicator-accuracy-core-return-stability-correction",
    "paper-trader/docs/agent/tasks/post-phase5-indicator-accuracy-core-return-stability-correction.md",
  ...
  "acceptance": [
    "Complete minimum/default/maximum and small-nonzero arrays pass exact Fraction/high-precision logarithmic expectations without tolerance relaxation or a new return/tick floor.",
    "Positive exact peer-return variance remains defined; exact zero-divisor and nonpositive-log-endpoint policies remain unchanged.",
    "Use deterministic arithmetic context and measure the new numerical path across the declared domain; no understated source resource ceiling.",
    "Run all 58 candidate and affected compatibility checks, causal/restart evidence, source/protected-byte proof and a killed/restored real numerical regression mutation.",
    "Perform the requested bounded near-flat normalized-statistic/residual sweep as evidence only. A reproduced additional defect requires explicit correction-scope amendment before implementation.",
    ...
    "All 18 near-flat exploration cases pass, including every named regression output; add permanent complete-array regression coverage for F03. MAD remains a no-change control."
  ],
  "test_plan": [
    "Complete minimum/default/maximum and small-nonzero arrays pass exact Fraction/high-precision logarithmic expectations without tolerance relaxation or a new return/tick floor.",
    "Positive exact peer-return variance remains defined; exact zero-divisor and nonpositive-log-endpoint policies remain unchanged.",
  ...
  "review": {
    "required": false,
    "assignment_id": "post_phase5_indicator_accuracy_core_return_stability_correction_owner",
    "agent": "owner",
    "model": "gpt-5.6-sol",
    "reasoning_effort": "medium",
    "base_sha": "HEAD",
    "package": ".agent/runs/post-phase5-indicator-accuracy-core-return-stability-correction/review-package.json",
    "review_paths": [
      "paper-trader/backend/app/ir/first_party/analytical_v2/core_math.py",
      "paper-trader/backend/tests/test_indicator_accuracy_core_math.py",
      ".agent/runs/post-phase5-indicator-accuracy-core-return-stability-correction"
    ...
    "output": ".agent/runs/post-phase5-indicator-accuracy-core-return-stability-correction/report.md",
    "verdicts": [
      "CORRECTION"
    ],
    "max_rechecks": 0
  ...
  "allowed_product_symbols": [
    "Return/log-return and BETA/ALPHA branches of _number, narrowly required pure arithmetic helpers/imports and their dependency identities, and measured resource profiles if required. No other formulas or replay-guard changes.",
    "F03 amendment: CCI, ZSCORE, VOLUME_ZSCORE, RESIDUAL and ROLLING_REGRESSION branches and narrowly shared pure precision helpers. Do not change _moments or the other level statistics, MAD or other formulas."
  ],
  "exploration_scope": [
    "CCI",
    "MAD",
  ...
  "scope_amendment": {
    "date": "2026-08-28",
    "finding": ".agent/runs/post-phase5-indicator-accuracy-core-return-stability-correction/near-flat-finding.json",
    "added_components": [
      "CCI",
      "RESIDUAL",
      "ROLLING_REGRESSION",
    ...
    "scope": "Numerically stable CCI, z-scores and level-regression/residual arithmetic only; preserve other formulas, declarations, masks, replay guard and shared files",
    "authority": "v0_standing_development_authorization",
    "before_product_edit": true
  },
  "coordination_transition": {
    "scope": "Closing metadata and exact next assurance capsule only; no next-stage product ownership",
    "authority": "v0_standing_development_authorization",
    "owner": "F02/F03 coordinator, serial"
  },
  "completion": {
...
Resolve F02 using numerically stable return/log-return and derived beta/alpha calculations, preserving strict thresholds, positive-variance validity, causal/restart behavior and bounded resource evidence.
