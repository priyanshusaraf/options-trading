...
(`tests` + `research_tests`) **2,612 collected, PYTEST EXIT 0** · `dryrun.py 700` LEDGER OK ·
...
|---|---|---|---|
| 1 | [WS-03 Research Plane](engineering/workstreams/WS-03-research-plane.md) | the search loop — F14 binding landed 2026-08-03 | no |
| 2 | [WS-08 Cockpit UI](engineering/workstreams/WS-08-cockpit-ui.md) | typography and palette pass | no |
